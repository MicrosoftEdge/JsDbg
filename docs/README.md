...
There are many different ways browser developers can incorporate JsDbg extensions into their debugging workflow. See [JsDbg features](./docs/FEATURES.md) for details about popular features in JsDbg.
...
See [Contributing to JsDbg](./docs/CONTRIBUTING.md) for more details about contributing to this project.
