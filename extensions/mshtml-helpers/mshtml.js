...
(function() {
    ...
    JsDbg.OnLoad(function() {
        ...
        DbgObject.AddExtendedField(moduleName, "CTreeNode", "FancyFormat", "CFancyFormat", function (treeNode) {
            return MSHTML.GetObjectFromDataCache(treeNode.f("_pts._pFancyFormatCache"), treeNode.f("_iFF").val());
        });

        DbgObject.AddExtendedField(moduleName, "CTreeNode", "CharFormat", "CCharFormat", function (treeNode) {
            return MSHTML.GetObjectFromDataCache(treeNode.f("_pts._pCharFormatCache"), treeNode.f("_iCF").val());
        });

        DbgObject.AddExtendedField(moduleName, "CTreeNode", "ParaFormat", "CParaFormat", function (treeNode) {
            return MSHTML.GetObjectFromDataCache(treeNode.f("_pts._pParaFormatCache"), treeNode.f("_iPF").val());
        });

        DbgObject.AddExtendedField(moduleName, "CTreeNode", "SvgFormat", "CSvgFormat", function (treeNode) {
            return MSHTML.GetObjectFromDataCache(treeNode.f("_pts._pSvgFormatCache"), treeNode.f("_iSF").val());
        });
